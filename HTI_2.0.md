...
| hti-version | string    | no       | The HTI version in the `hti-version` claim needs to match the used HTI version. If not provided 2.0 must be assumed.                                                                                                                                                                                                                                         |
...
| The fields used in the HTI claims object MUST match the table of ② The message format.                                                                                                                                                                          |
