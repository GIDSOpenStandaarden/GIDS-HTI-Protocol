...
| intent | no | This field **MAY** be populated with a value from the [FHIR value set RequestIntent]([https://www.hl7.org/fhir/R4/valueset-request-intent.html](https://build.fhir.org/ig/HL7/smart-app-launch/scopes-and-launch-context.html#launch-intent)). |
| status | yes | Status of the task. This field must be populated with one of the values defined by the [SMART on FHIR App Launch Intent](https://build.fhir.org/ig/HL7/smart-app-launch/scopes-and-launch-context.html#launch-intent). |
